...
import { Header, H1, H2, HeroSection, HeroText, HeroImage, CTAButton, CTAText, SubSection, SectionOne, SectionTwo, SubSectionText, SubSectionImage, StyledLink } from './styles';
